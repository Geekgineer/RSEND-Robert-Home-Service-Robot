...
xterm -geometry 50x15+805+250  -e "source devel/setup.bash; roslaunch robert gmapping.launch" &
sleep 5

xterm -geometry 50x15+500+488  -e "source devel/setup.bash; roslaunch robert_rviz_launchers view_navigation.launch" &
sleep 5
xterm -geometry 50x15+805+488  -e "source devel/setup.bash; rosrun teleop_twist_keyboard teleop_twist_keyboard.py"
