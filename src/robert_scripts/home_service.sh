...
xterm -geometry 50x15+805+488 -e "source devel/setup.bash; rosrun robert_add_markers robert_add_markers" &

sleep 5 

xterm -geometry 50x15+1105+488 -e "source devel/setup.bash; rosrun robert_pick_objects robert_pick_objects"
